...
- 评测时间：2026-07-23T07:05:29.083911+00:00

| 指标 | 分子 | 分母 | 比率 | 后续 V2 目标 |
|---|---:|---:|---:|---:|
| recall_at_12 | 30 | 47 | 0.638298 | >= 90% |
| priority_top_12_coverage | 15 | 16 | 0.9375 | >= 95% |
| prerequisite_coverage | 3 | 13 | 0.230769 | >= 90% |
| source_completeness | 238 | 238 | 1.0 | = 100% |

- 跨领域错误：0
- 延迟：P50 1.661 ms，P95 1.972 ms
